...
class AETrainer:
    def __init__(self, view, n_cluster, config: dict, device: torch.device):
        self.view = view
        ...
        self.weights_path = "weights/ae_weights"
    ...
    def train(self, X: torch.Tensor) -> AEModel:
        ...
        if os.path.exists(self.weights_path+"_{}.pth".format(self.view)):
            self.ae_net.load_state_dict(torch.load(self.weights_path+"_{}.pth".format(self.view)))
            return self.ae_net
        ...
        torch.save(self.ae_net.state_dict(), self.weights_path+"_{}.pth".format(self.view))
        return self.ae_net
